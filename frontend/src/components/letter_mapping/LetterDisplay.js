        ...
        <div className="letter-display">
            <div className="explanation-div">
                ...
                <h3 id="explanation">
                    ...
                    2 corresponding letters. When a the game starts, 
                    one of these six letters will be shown on screen.
                    Press the key and/or button that corresponds to that letter to gain points. 
                    1/2 points are given out whenever the key is visible during the game.
                </h3>
